...
urlpatterns = [
    ...
    path('evento/delete/<int:id_evento>/', views.delete_evento, name='evento_delete'),
    #path('', views.index) METODO UM
    #path('', RedirectView.as_view(url='/agenda/')),
    path('', views.lista_eventos),
    path('evento/todos', views.lista_eventos_todos, name='lista_eventos_todos' ),
